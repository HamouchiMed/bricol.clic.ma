...
export default function VerificationScreen({ navigation, route }) {
  const { isNewUser, role } = route.params || {};
        ...
        <View style={styles.footer}>
          <View style={styles.buttonRow}>
             <TouchableOpacity style={styles.skipButton} onPress={() => navigation.navigate('Dashboard')}>
               <Text style={styles.skipButtonText}>Pas maintenant</Text>
             </TouchableOpacity>
             <TouchableOpacity 
             ...
             >
               <Text style={styles.nextButtonText}>
                 {step === 4 ? "Retour à l'accueil" : step === 3 ? 'Soumettre' : 'Continuer'}
               </Text>
